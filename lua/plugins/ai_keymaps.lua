...
map(
  'n',
  '<leader>aA',
  function() require('codecompanion').prompt 'agent' end,
  { desc = 'Agent mode' }
)
map(
  'n',
  '<leader>ab',
  function() require('codecompanion').prompt 'background' end,
  { desc = 'Background chat' }
)
...
map(
  { 'x', 'o' },
  '<leader>ad',
  function() require('codecompanion').prompt 'docs' end,
  { desc = 'Add docstrings' }
)
map(
  { 'x', 'o' },
...
map(
  { 'x', 'o' },
  '<leader>ai',
  function() require('codecompanion').prompt 'inline' end,
  { desc = 'Inline prompt' }
)
map(
  { 'x', 'o' },
...
map(
  { 'x', 'o' },
  '<leader>aR',
  function() require('codecompanion').prompt 'refactor' end,
  { desc = 'Refactor code' }
)
map(
  { 'x', 'o' },
  '<leader>at',
  function() require('codecompanion').prompt 'translate' end,
  { desc = 'Translate code' }
)
...
map(
  'n',
  '<leader>aE',
  function() require('codecompanion').prompt 'explainbuf' end,
  { desc = 'Explain buffer' }
)
map(
  'n',
  '<leader>aD',
  function() require('codecompanion').prompt 'docsgen' end,
  { desc = 'Generate project docs' }
)
map(
  'n',
  '<leader>ag',
...
map(
  'n',
  '<leader>ap',
  function() require('codecompanion').prompt 'pr' end,
...
map(
  ...
  { desc = 'Send diagnostics to CLI agent' }
)
...
map(
  'n',
  '<leader>act',
  function() return require('codecompanion').cli('#{terminal}', { focus = false, submit = true }) end,
  { desc = 'Send terminal output to CLI agent' }
)
